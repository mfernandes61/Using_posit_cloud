...
![New project](images/posit-cloud-newproject.png)    
6. After a short wait you should see an Rstudio layout like the one in the course notes. 
![Rstudio session](images/posit-cloud-rstudio-project.png)    
...
![Export your scripts](images/posit-cloud-export-files.png)
